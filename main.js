// Intersection Observer to reveal images when they enter the viewport
  (function () {
    ...
    // Countdown to October 25, 12:00 PM (local time). If date has passed this year, target next year.
    (function initCountdown() {
      ...
      let target = new Date(year, 9, 25, 12, 0, 0, 0); // Month is 0-based; 9 => October
      if (target.getTime() <= now.getTime()) {
        target = new Date(year + 1, 9, 25, 12, 0, 0, 0);
      }
